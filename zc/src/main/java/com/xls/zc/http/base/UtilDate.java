...
public class UtilDate {
	 ...
	 * @return
	 */
	public static Integer timeDifference(Date preDate,Date laterDate) {
		if(preDate == null || laterDate == null) {
			return null;
		}
		return (int)(laterDate.getTime() - preDate.getTime());
	}
}
