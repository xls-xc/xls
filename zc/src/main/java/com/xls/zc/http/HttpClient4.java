 ...
 * @Description: 前JAVA实现HTTP请求的方法用的最多的有两种：
 ...
 * @Author: SkyChen
 * @Create: 2020-04-24 20:20
 * @Version: v1.0
 **/
public class HttpClient4 {
    /**
     * 有时候我们在使用post请求时，可能传入的参数是json或者其他格式，此时我们则需要更改请求头及参数的设置信息，
     * 以httpClient4.5为例，更改下面两列配置：
    ...
    public static String doPostMap(String url, Map<String, Object> paramMap) {
        CloseableHttpClient httpClient = null;
