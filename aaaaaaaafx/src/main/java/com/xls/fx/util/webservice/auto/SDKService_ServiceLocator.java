...
public class SDKService_ServiceLocator extends org.apache.axis.client.Service implements SDKService_Service {
    ...
    public SDKService_ServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for SDKService
    private String SDKService_address = "http://hprpt2.eucp.b2m.cn:8080/sdk/SDKService";
    ...
    public SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.xls.fx.util.webservice.auto.SDKServiceBindingStub _stub = new com.xls.fx.util.webservice.auto.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                com.xls.fx.util.webservice.auto.SDKServiceBindingStub _stub = new com.xls.fx.util.webservice.auto.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
